...
animals = [camello, leon, ciervo, ganzo, murcielago, conejo]
res = ""
while True:
   res = input("que habitad # necesitas? (del 0 al 5), escribe exit para salir > ")
   if res.lower() == "exit":
      break
   print(animals[int(res)])
print("Hasta la proxima vaquero!")